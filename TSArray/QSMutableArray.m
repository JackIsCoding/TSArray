...
//  PreferenceDemo
//
//  Created by Guojiang on 2017/7/1.
//  Copyright © 2017年 Guojiang. All rights reserved.
//

#import "QSMutableArray.h"

@interface QSMutableArray ()
{
...
- (instancetype)initCommon{
    ...
    if (self) {
        ...
        NSString* uuid = [NSString stringWithFormat:@"com.threadsafe.array_%p", self];
        //注意：_syncQueue是并行队列
